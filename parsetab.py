...
_lr_productions = [
  ...
  ('function -> function funcname OPENCURL code return EOL CLOSECURL','function',7,'p_function','parse.py',163),
  ...
  ('code -> code return EOL','code',3,'p_code','parse.py',205),
  ('code -> empty','code',1,'p_code','parse.py',206),
  ('return -> RETURN expression','return',2,'p_return','parse.py',214),
  ('io -> INPUT OPENPAR QUOTEMARK percenttype QUOTEMARK COMMA AMP NAME CLOSEPAR','io',9,'p_io','parse.py',220),
  ('io -> OUTPUT OPENPAR QUOTEMARK percenttype QUOTEMARK COMMA NAME CLOSEPAR','io',8,'p_io','parse.py',221),
  ...
  ('bcode -> bcode while','bcode',2,'p_bcode','parse.py',303),
  ('bcode -> bcode if','bcode',2,'p_bcode','parse.py',304),
  ('bcode -> bcode expression EOL','bcode',3,'p_bcode','parse.py',305),
  ('bcode -> bcode BREAK EOL','bcode',3,'p_bcode','parse.py',306),
  ('bcode -> bcode return EOL','bcode',3,'p_bcode','parse.py',307),
  ...
  ('varname -> NAME COMMA varname','varname',3,'p_varname','parse.py',356),
  ('varname -> NAME','varname',1,'p_varname','parse.py',357),
  ('varname -> empty','varname',1,'p_varname','parse.py',358),
  ('expression -> INT','expression',1,'p_expression_int_float','parse.py',376),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','parse.py',377),
  ('expression -> NAME','expression',1,'p_expression_int_float','parse.py',378),
  ('expression -> FNAME OPENPAR varname CLOSEPAR','expression',4,'p_expression_function','parse.py',384),
